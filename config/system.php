...
return [
    ...
    */
    ...
    │-----------------------------------------------------------------------------
    │
    │ Если события не будут использоваться, то их можно отключить в этом параметре
    │ и удалить папку /app/Bootstrap/Events/.
    │ Изначально: true
    │
    */
    'events.used' => false,
    ...
    /*
    │-----------------------------------------------------------------------------
    │ Autowiring mode for Dependency Injection
    │-----------------------------------------------------------------------------
    │
    ...
    │
    │-----------------------------------------------------------------------------
    │ Режим автоматического разрешения зависимостей для DI
    │-----------------------------------------------------------------------------
    │
