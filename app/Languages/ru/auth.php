...
return [
    ...
    'login_info'    => 'Авторизация дает возможность участвовать в работе каталога, размещать сайты и др.',
    'invate_text'   => 'Еще не пользователь? Регистрация осуществляется только по приглашению для борьбы со спамом и повышения ответственности. Если вы знаете <i>текущего пользователя</i> сайта, попросите у него приглашение.',
